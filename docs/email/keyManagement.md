...
署名した公開鍵をPGP公開鍵サーバに登録することで、他の人が信頼度の参考にすることができます^[重複する電子メールアドレスの鍵をアップロードすると、鍵サーバに既存の公開鍵からユーザーIDが削除されるようです。それぞれの電子メールアドレスに紐付ける鍵対はひとつに限っておいた方が問題が起きにくいかもしれません。]
